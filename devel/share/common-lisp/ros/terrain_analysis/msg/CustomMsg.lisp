...
(cl:in-package terrain_analysis-msg)
...
(cl:defclass <CustomMsg> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (points
    :reader points
    :initarg :points
    :type (cl:vector terrain_analysis-msg:CustomPoint)
   :initform (cl:make-array 0 :element-type 'terrain_analysis-msg:CustomPoint :initial-element (cl:make-instance 'terrain_analysis-msg:CustomPoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <CustomMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CustomMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name terrain_analysis-msg:<CustomMsg> is deprecated: use terrain_analysis-msg:CustomMsg instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <CustomMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader terrain_analysis-msg:header-val is deprecated.  Use terrain_analysis-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'timebase-val :lambda-list '(m))
(cl:defmethod timebase-val ((m <CustomMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader terrain_analysis-msg:timebase-val is deprecated.  Use terrain_analysis-msg:timebase instead.")
  (timebase m))

(cl:ensure-generic-function 'point_num-val :lambda-list '(m))
(cl:defmethod point_num-val ((m <CustomMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader terrain_analysis-msg:point_num-val is deprecated.  Use terrain_analysis-msg:point_num instead.")
  (point_num m))

(cl:ensure-generic-function 'lidar_id-val :lambda-list '(m))
(cl:defmethod lidar_id-val ((m <CustomMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader terrain_analysis-msg:lidar_id-val is deprecated.  Use terrain_analysis-msg:lidar_id instead.")
  (lidar_id m))

(cl:ensure-generic-function 'rsvd-val :lambda-list '(m))
(cl:defmethod rsvd-val ((m <CustomMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader terrain_analysis-msg:rsvd-val is deprecated.  Use terrain_analysis-msg:rsvd instead.")
  (rsvd m))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <CustomMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader terrain_analysis-msg:points-val is deprecated.  Use terrain_analysis-msg:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CustomMsg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'terrain_analysis-msg:CustomPoint))

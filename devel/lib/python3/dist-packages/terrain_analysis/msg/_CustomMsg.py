...
"""autogenerated by genpy from terrain_analysis/CustomMsg.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','uint64','uint32','uint8','uint8[3]','terrain_analysis/CustomPoint[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = terrain_analysis.msg.CustomPoint()
        _x = val1
        start = end
        end += 19
